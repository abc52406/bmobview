...
// 生成文件目录
moduleExports.buildName = 'dist';
moduleExports.buildDir = path.resolve(moduleExports.staticRootDir, './' + moduleExports.buildName);// 存放编译后生成的所有代码、资源（图片、字体等，虽然只是简单的从源目录迁移过来）
